...
class SoloNode(Node):
    ...
    def initial_solo(self):
        ...
        self.solo_L.set_motion_profile_variable1(34)
        self.solo_L.set_motion_profile_variable2(40)
        ...
        self.solo_R.set_motion_profile_variable1(34)
        self.solo_R.set_motion_profile_variable2(40)
            ...
            for port in ports:
                try:
                    if solo_L == None :
                        ...
                        if is_working:
                            print(f"{port} responds to address 0 (Left)")
                            solo_L = solo1
                            continue
                except :
                    print("L not sucess")
                ...
                try:
                    if solo_R == None :
                        ...
                        if is_working:
                            print(f"{port} responds to address 1 (Right)")
                            solo_R = solo2
                            continue
                except :
                    print("R not sucess")
